<?php
    ...
    if (isset($_GET["Notify"])) {
        $notify = $_GET["Notify"];
        if (isset($_GET["IDHEAD"])) {
            $id_head = $_GET["IDHEAD"];
            $link = "new_headquarter.php?ID_HEAD=" . $id_head ;
        }
        else {
            $link = "new_headquarter.php";
        }
    }
    else {
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Thông báo</h4> </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="white-box">
                            <p class="text-justify">Này <b><?php echo $admin_name; ?></b>, <?php echo $notify; ?></p>
                            <a role="button" class="btn btn-warning" href="<?php echo $link; ?>">Quay lại</a>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
